...
# Example
```julia
julia> d, extent = SeisHypEvents(); dnoisy = SeisAddNoise(d, 2); SNR(d, dnoisy)
```
"""

function SNR{Ts<:Real, Tn<:Real, N}(signal::Array{Ts, N}, noisy::Array{Tn, N};
                         db::Bool=false)
